...
impl MasterKey {
  ...
  pub fn new_bitcoin_receive_qrcode(&self,account_index: u32,address_index: u32,amount: u32, label: &str, message: &str)->String{
      let bitcoin_address = self.new_bitcoin_receive_address(account_index,address_index);
      let uri = format!(
